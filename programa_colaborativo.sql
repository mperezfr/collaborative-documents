...
-- This table has the emails of users that can create a user in the table users
CREATE TABLE IF NOT EXISTS `users_can_participate` (
`id` int(11) NOT NULL,
  `nombre` varchar(40) COLLATE utf8_bin NOT NULL,
  `apellidos` varchar(100) COLLATE utf8_bin NOT NULL,
  `email` varchar(100) COLLATE utf8_bin NOT NULL,
...
ALTER TABLE `users_can_participate`
 ADD PRIMARY KEY (`id`);
